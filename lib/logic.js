...
async function CheckoutAsset (rentalAssetValue) {
	...
	checkout.checkout_ID = checkoutID;
  	checkout.checkout_time = ("0"+parseInt(current_time.getHours())).slice(-2) + ':' + current_time.getMinutes();
	checkout.due_by = ("0"+(parseInt(current_time.getHours()) + 3)).slice(-2) + ':' + current_time.getMinutes();
